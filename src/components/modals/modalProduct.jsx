...
class ModalProduct extends Component {
    ...
    render() {
        ...
        let { product, newBranch, branchs, idProductBranchs, categorySelected } = this.state
        return (
            <React.Fragment>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className +' modal-dialog-centered modal-lg'}>
                    ...
                    <ModalBody>
                        ...
                        <div className="row pt-3">
                            ...
                            <div className="col-md-3">
                                <select value={id_category} name="id_category" className="form-control" onChange={this.handleInput}>
                                    <option value={id_category} hidden>{categorySelected}</option>
                                    {
                        ...
                        <div className="row pt-3">
                            ...
                            <div className="col-md-4">
                                <input type="number" className="form-control" name="price" value={price} onChange={this.handleInput} />
                            </div>
                        </div>
                        <div className="row pt-3">
                            <div className="col-md-3" style={{ marginRight: '-55px !important' }}>
                    ...
                    <ModalFooter style={{borderTop: 'none'}}>
                        <button type="button" className={this.props.class} onClick={() => {this.props.onUpdate(product, newBranch, idProductBranchs); this.setState({modal:false})} }>Edit</button>
                    </ModalFooter>
                </Modal>
            </React.Fragment>
        );
